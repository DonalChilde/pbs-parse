...
from tests.resources.trips import TRIPS_INDEXED_ANCHOR
...
def test_parse_trips(
    ...
    file_resource = resources.files(parse_trips_one.indexed_anchor).joinpath(
    ...
    with resources.as_file(file_resource) as input_path:
        ...
        ctx = ParseContext(beginning_state=scheme.beginning_state)
